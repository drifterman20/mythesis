...
\renewcommand{\headrule}{\color{red} \headruleORIG}
...
% reinstate the correct level for list of tables, figures and algorithms
...
%\includepdf[pages=-]{00-eng-Page-de-garde.pdf}
%\includepdf[pages=-]{00-fr-Page-de-garde.pdf}
\include{cover-page}

\include{01-Dedicace-Karim}
\pagenumbering{Roman}
%\include{00-Note}
\include{02-Remerciements}
\include{Abstract}
\include{03-Resume}
\includepdf[pages=-]{ArabicAbstract.pdf}
...
\include{06-chap1:GeneralIntroduction}
\include{07-Chap2:StateOfTheArt}
\include{08-Chap3:Conception_and_implementation}
\include{09-Chap4:ModelsOptimization}
